...
```{r, groot-missing-trait, fog.pos = "H", fig.cap="Percentage of species where trait is present for the 15 most available traits in the whole GRooT dataset"}
...
```{r, TRY-pair-plot, fig.pos = "H", fig.cap="Pair plot with all the continous trait used in the analysis from the TRY and GRooT dataset. Red line in scatter plot are a linear regression line. Stars (*) next to the correlation coefficient represents the significance level."}
pair_plots(TRY_pca)
```
